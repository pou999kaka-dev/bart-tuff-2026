-- Bart Tuff Hub (RITUAL & KEY ANIMATIONS UPDATE)
...
local function RunIntro()
    ...
    wait(1.1)
    IntroText.Text = "by: Pou999kaka02"
    ...
    if state then
        ...
        spawn(function()
            ...
            while States.Ritual and char and char:FindFirstChild("Humanoid") and char.Humanoid.Health > 0 do
                ...
                if spinSpeed > 150 then
                    wait(1)
                    char.Humanoid.Health = 0 -- Respawn
                    break
                end
...
-- Lógica de Acesso com Animações de Erro/Sucesso
