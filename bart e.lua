-- Bart Tuff Hub (BEACONS & FLUORESCENT COLORS UPDATE)
...
local function CreateButton(name, callback, customColor)
    local Button = Instance.new("TextButton", ButtonsFrame)
    local BtnCorner = Instance.new("UICorner", Button)
    Button.BackgroundColor3 = customColor or Color3.fromRGB(30, 30, 30)
    ...
    local active = false
    Button.MouseEnter:Connect(function() if not active then TweenService:Create(Button, TweenInfo.new(0.3), {BackgroundColor3 = (customColor and customColor:lerp(Color3.new(0,0,0), 0.2)) or Color3.fromRGB(20, 20, 20)}):Play() end end)
    Button.MouseLeave:Connect(function() if not active then TweenService:Create(Button, TweenInfo.new(0.3), {BackgroundColor3 = customColor or Color3.fromRGB(30, 30, 30)}):Play() end end)
...
end, Color3.fromRGB(0, 255, 0)) -- Verde Fluorescente Puro
