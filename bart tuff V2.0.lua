-- Bart Tuff Hub (ROTATING BEACONS & TEXT STROKE UPDATE)
...
local function CreateBeacon(pos, color, id)
    ...
    bbg.Size = UDim2.new(0, 200, 0, 80)
    bbg.AlwaysOnTop = true
    bbg.ExtentsOffset = Vector3.new(0, 52, 0)
    
    local labelDist = Instance.new("TextLabel", bbg)
    labelDist.Size = UDim2.new(1, 0, 0, 30)
    labelDist.Position = UDim2.new(0, 0, 0, 30)
    labelDist.BackgroundTransparency = 1
    labelDist.TextColor3 = Color3.fromRGB(255, 255, 255)
    labelDist.TextStrokeTransparency = 0
    labelDist.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
    labelDist.Font = Enum.Font.SourceSansBold
    labelDist.TextSize = 22
    
    local labelTitle = Instance.new("TextLabel", bbg)
    labelTitle.Size = UDim2.new(1, 0, 0, 30)
    labelTitle.Position = UDim2.new(0, 0, 0, 0)
    labelTitle.BackgroundTransparency = 1
    labelTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
    labelTitle.TextStrokeTransparency = 0
    labelTitle.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
    labelTitle.Font = Enum.Font.SourceSansBold
    labelTitle.TextSize = 24
    labelTitle.Text = "Teleporte " .. id
    ...
    spawn(function()
        while beacon.Parent do
            ...
            labelDist.Text = "distância: " .. dist
            beacon.CFrame = beacon.CFrame * CFrame.Angles(0, math.rad(2), 0) -- Rotação suave
            wait(0.01)
        end
    end)
end
