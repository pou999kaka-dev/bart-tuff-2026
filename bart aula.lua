-- Bart Tuff Hub (SAVED POSITIONS UPDATE)
...
-- TELEPORTES E SALVAMENTO DE POSIÇÃO
CreateButton("Teleporte 1", function()
    local root = Players.LocalPlayer.Character and Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
    if root and SavedPos1 then
        root.CFrame = SavedPos1
    end
end)
...
CreateButton("Salvar Posição 1", function()
    local root = Players.LocalPlayer.Character and Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
    if root then
        SavedPos1 = root.CFrame
    end
end)

CreateButton("Teleporte 2", function()
    local root = Players.LocalPlayer.Character and Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
    if root and SavedPos2 then
        root.CFrame = SavedPos2
    end
end)
